...
public class TimeZonePickerDialogFragment extends DialogFragment implements TimeZonePickerView.OnTimeZoneSetListener {
    ...
    public TimeZonePickerDialogFragment setThemeDark() {
        mStyleResId = R.style.BetterPickersRadialTimePickerDialog_Dark;
        return this;
    }

    public TimeZonePickerDialogFragment setThemeLight() {
        mStyleResId = R.style.BetterPickersRadialTimePickerDialog_Light;
        return this;
    }

    public TimeZonePickerDialogFragment setThemeCustom(int styleResId) {
