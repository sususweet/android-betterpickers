...
public class TimeZoneResultAdapter extends BaseAdapter implements OnItemClickListener,
    ...
    private Drawable bodyBgDrawable;
    ...
    public TimeZoneResultAdapter(Context context, TimeZoneData tzd, TimeZonePickerView.OnTimeZoneSetListener l,
        ...
        bodyBgDrawable = themeColors.getDrawable(R.styleable.BetterPickersDialogs_bpListItemBackground);
        bodyTextColor = themeColors.getColor(R.styleable.BetterPickersDialogs_bpBodyTextColor, mResources.getColor(R.color.bpblack));
        themeColors.recycle();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            v.setBackground(bodyBgDrawable);
        }
        ...
        vh.timeZone.setTextColor(bodyTextColor);
        vh.timeOffset.setTextColor(bodyTextColor);
        vh.location.setTextColor(bodyTextColor);
