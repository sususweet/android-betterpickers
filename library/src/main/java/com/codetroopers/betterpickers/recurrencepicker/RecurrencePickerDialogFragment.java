...
public class RecurrencePickerDialogFragment extends DialogFragment implements OnItemSelectedListener,
    ...
    private static final String TAG = "SimpleRecurrencePicker";
    ...
    private AppCompatEditText mInterval;
    ...
    private AppCompatEditText mEndCount;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mInterval = (AppCompatEditText) mView.findViewById(R.id.interval);
        ...
        mEndCount = (AppCompatEditText) mView.findViewById(R.id.endCount);
        ...
        mDoneButton = (AppCompatButton) mView.findViewById(R.id.done_button);
