...
public class SimpleRecurrencePickerDialogFragment extends DialogFragment implements OnItemSelectedListener,
        OnClickListener, CalendarDatePickerDialogFragment.OnDateSetListener {
    ...
    private static class RecurrenceModel implements Parcelable {
        ...
        public String toString() {
            return "Model [freq=" + freq + ", interval=" + interval + ", end=" + end + ", endDate="
                    ...
                    + Arrays.toString(weeklyByDayOfWeek) + "]";
        }
    ...
    public SimpleRecurrencePickerDialogFragment() {
    ...
    public SimpleRecurrencePickerDialogFragment setThemeDark() {
        mStyleResId = R.style.BetterPickersRadialTimePickerDialog_Dark;
        return this;
    }

    public SimpleRecurrencePickerDialogFragment setThemeLight() {
        mStyleResId = R.style.BetterPickersRadialTimePickerDialog_Light;
        return this;
    }

    public SimpleRecurrencePickerDialogFragment setThemeCustom(int styleResId) {
        ...
        switch (model.end) {
            case RecurrenceModel.END_BY_DATE:
                if (model.endDate != null) {
                    ...
                    // since mobile use second
                    eventRecurrence.until = Long.toString(model.endDate.toMillis(false)/1000);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        int bodyBgColor = themeColors.getColor(R.styleable.BetterPickersDialogs_bpBodyBackgroundColor, mResources.getColor(R.color.bpWhite));
        int bodyTextColor = themeColors.getColor(R.styleable.BetterPickersDialogs_bpBodyTextColor, mResources.getColor(R.color.bpblack));
        int buttonBgColor = themeColors.getColor(R.styleable.BetterPickersDialogs_bpButtonsBackgroundColor, mResources.getColor(R.color.bpWhite));
        int buttonTextColor = themeColors.getColor(R.styleable.BetterPickersDialogs_bpButtonsTextColor,mResources.getColor( R.color.bpBlue));

        themeColors.recycle();

        mView = inflater.inflate(R.layout.recurrencepicker, container, true);
        mView.setBackgroundColor(bodyBgColor);

        mHeader = (LinearLayout) mView.findViewById(R.id.recurrence_header);
        mHeader.setBackgroundColor(bodyBgColor);
        ...
        mInterval.setTextColor(bodyTextColor);
        ...
        mIntervalPreText.setTextColor(bodyTextColor);
        mIntervalPostText = (TextView) mView.findViewById(R.id.intervalPostText);
        mIntervalPostText.setTextColor(bodyTextColor);
        ...
        mEndCount.setTextColor(bodyTextColor);
        ...
        mPostEndCount.setTextColor(bodyTextColor);

        mEndDateButton = (Button) mView.findViewById(R.id.endDate);
        ...
        mView.findViewById(R.id.ok_cancel_buttons_layout).setBackgroundColor(buttonBgColor);
        mView.findViewById(R.id.options).setBackgroundColor(bodyBgColor);
        mEndDateButton.setTextColor(buttonTextColor);
    ...
    private void updateDoneButtonState() {
        ...
        // only one choice for FREQ_WEEKLY now.
...
//        }
    ...
    public void updateDialog() {
        ...
        if (mModel.end == RecurrenceModel.END_BY_DATE) {
            ...
            mEndDateButton.setText(dateStr);
        } else {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if (parent == mFreqSpinner) {
            ...
            mEndCount.setVisibility(mModel.end == RecurrenceModel.END_BY_COUNT ? View.VISIBLE
                    : View.GONE);
            mEndDateButton.setVisibility(mModel.end == RecurrenceModel.END_BY_DATE ? View.VISIBLE
                    : View.GONE);
